...
# def _assert_user_created(payload):
...
# def _send_seller_registration_request(payload):
#     mail.outbox = []
#     response = client.post("/api/v1/auth/signup/seller/", payload)
#     assert response.status_code == status.HTTP_201_CREATED
#     assert response.data["detail"] == "Verification e-mail sent."


# def _assert_seller_created(payload):
#     user = CustomUser.objects.get(username=payload["username"])
...
# def test_create_user(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     _assert_user_created(payload)
#     _assert_email_sent()


# def test_create_user_with_invalid_email(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
...
# def test_create_user_with_invalid_password(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
...
# def test_create_user_with_duplicate_username_and_email(
#     user_registration_payload_factory,
# ):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     response = client.post("/api/v1/auth/signup/user/", payload)
...
# def test_create_seller(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_seller_registration_request(payload)
#     _assert_seller_created(payload)
#     _assert_email_sent()


# def test_create_seller_with_invalid_email(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     payload["email"] = "invalid_email"
#     response = client.post("/api/v1/auth/signup/seller/", payload)
...
# def test_create_seller_with_invalid_password(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     payload["password1"] = "123"
#     payload["password2"] = "123"
#     response = client.post("/api/v1/auth/signup/seller/", payload)
...
# def test_create_seller_with_duplicate_username_and_email(
#     user_registration_payload_factory,
# ):
#     payload = user_registration_payload_factory()
#     _send_seller_registration_request(payload)
...
# def test_verify_email(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
...
# def test_verify_email_with_invalid_code(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
...
# def test_verify_email_with_used_code(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     verification_code = extract_verification_code_from_email(mail.outbox[0].body)
#     response = client.post(reverse("rest_verify_email"), {"key": verification_code})
...
# def test_verify_email_with_expired_code(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     verification_code = extract_verification_code_from_email(mail.outbox[0].body)
...
# def test_resend_verification_email(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     response = client.post(reverse("rest_resend_email"), {"email": payload["email"]})

#     assert response.status_code == status.HTTP_200_OK
#     assert response.data["detail"] == "ok"


# def test_resend_verification_email_with_invalid_email(
#     user_registration_payload_factory,
# ):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
...
# def test_login_with_invalid_credentials(user_registration_payload_factory):
#     payload = {
#         "username": "user01",
...
# def test_login(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
#     verification_code = extract_verification_code_from_email(mail.outbox[0].body)
#     response = client.post(reverse("rest_verify_email"), {"key": verification_code})
...
#     # _send_logout_request(response.data["access"])
#     client.logout()
#     # _send_logout_request()
#     seller_payload = user_registration_payload_factory()
#     _send_seller_registration_request(seller_payload)
#     verification_code = extract_verification_code_from_email(mail.outbox[0].body)
#     response = client.post(reverse("rest_verify_email"), {"key": verification_code})
...
#         reverse("rest_login"),
#         {
#             "username": seller_payload["username"],
#             "email": seller_payload["email"],
#             "password": seller_payload["password1"],
#         },
#     )
...
# def test_hudai(user_registration_payload_factory):
#     payload = user_registration_payload_factory()
#     _send_registration_request(payload)
